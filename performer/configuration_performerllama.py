...
class PerformerLlamaConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.performer_attention_config = PerformerAttentionConfig(
            attention_dropout = 0.0, # since there is no dropout in llama
            kernel_type = kernel_type,
            causal = True,
            use_recurrent_decoding = use_recurrent_decoding,
            ...
            use_thick_features = use_thick_features,
            regularize_feature_norms = regularize_feature_norms,
            use_orthogonal_features = use_orthogonal_features,
            orthogonal_feature_algorithm = orthogonal_feature_algorithm,
            feature_redraw_interval = feature_redraw_interval,
            redraw_stochastically = redraw_stochastically,
            redraw_verbose = redraw_verbose,
            d_model = hidden_size,
